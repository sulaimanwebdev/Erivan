      ...
      <div className="bg-black w-full mt-[100px]">
        <div className="mainCont py-16 flex items-start md2:justify-between gap-14 md2:gap-0 flex-col md2:flex-row">
          ...
          <div className="flex items-start flex-col md2:flex-row gap-14 md2:gap-[90px] lg4:gap-[150px]">
            <div>
              <div className="text-white font-[700] text-[20px] mb-5">
                Pages
              </div>
              <div className="flex flex-col gap-2.5">
                <Link
                  href="/"
                  className="text-[15px] transition hover:-translate-y-[1px]"
                >
                  {t("home")}
                </Link>
                <Link
              ...
              <div className="flex flex-col gap-5">
                <div className="flex items-start gap-4">
                  ...
                  <div className="text-[15px] leading-[24px]">
                    Sainte-Julie, QC <br /> Mississauga, ON <br /> Calgary, AB
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div className="text-[15px] leading-[24px]">
                    450-922-3000 <br />
                    647-616-8494 <br /> 403-475-5888
                  </div>
                </div>

                <a
                  href="mailto:admin@erivan-gecom.com"
