  ...
  return (
    <>
      <div className="mainCont relative z-[50] py-8 flex items-center justify-between gap-3">
        <div className="flex items-center lg10:gap-6 lg8:gap-7 w-full lg10:w-auto">
          ...
          >
            <Link
              href="/"
              className={`font-semibold transition hover:-translate-y-1 ${home && home === true ? "text-white" : ""}`}
            >
              {t("home")}
            </Link>
            <Link
              href="/about-us"
              className={`font-semibold transition hover:-translate-y-1 ${
            ...
            <Link
              ...
              className={`font-semibold transition hover:-translate-y-1 ${
                typeof window !== "undefined"
                  ? window.location.pathname === "/experiences-&-services"
                    ? "text-white"
                    : ""
                  : ""
              }`}
            ...
            <Link
              ...
              className={`font-semibold transition hover:-translate-y-1 ${
                typeof window !== "undefined"
                  ? window.location.pathname === "/our-involvement"
                    ? "text-white"
                    : ""
                  : ""
              }`}
            ...
            <div className="flex sm2:hidden items-center gap-5">
              ...
              <div className="relative cursor-pointer rounded-full border-2 flex items-center justify-between border-white border-opacity-[0.16] px-2 w-[72px] h-[37px] bg-[#020510]">
                ...
                >
                  <path
                    d="M7.99984 12.0001C6.93897 12.0001 5.92156 11.5787 5.17141 10.8285C4.42126 10.0784 3.99984 9.06095 3.99984 8.00008C3.99984 6.93922 4.42126 5.9218 5.17141 5.17165C5.92156 4.42151 6.93897 4.00008 7.99984 4.00008C9.0607 4.00008 10.0781 4.42151 10.8283 5.17165C11.5784 5.9218 11.9998 6.93922 11.9998 8.00008C11.9998 9.06095 11.5784 10.0784 10.8283 10.8285C10.0781 11.5787 9.0607 12.0001 7.99984 12.0001ZM7.33317 0.666748H8.6665V2.66675H7.33317V0.666748ZM7.33317 13.3334H8.6665V15.3334H7.33317V13.3334ZM2.34317 3.28608L3.28584 2.34341L4.69984 3.75741L3.75717 4.70008L2.34317 3.28675V3.28608ZM11.2998 12.2427L12.2425 11.3001L13.6565 12.7141L12.7138 13.6567L11.2998 12.2427ZM12.7138 2.34275L13.6565 3.28608L12.2425 4.70008L11.2998 3.75741L12.7138 2.34341V2.34275ZM3.75717 11.3001L4.69984 12.2427L3.28584 13.6567L2.34317 12.7141L3.75717 11.3001ZM15.3332 7.33342V8.66675H13.3332V7.33342H15.3332ZM2.6665 7.33342V8.66675H0.666504V7.33342H2.6665Z"
                    fill="white"
                  />
                </svg>
              </div>
