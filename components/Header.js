      ...
      <div className="mainCont relative z-[50] py-8 flex items-center justify-between gap-3">
           <div className='flex items-center lg9:gap-6 lg8:gap-14 w-full lg9:w-auto'>
            ...
            <div className={`${navBar} lg9:translate-x-0 transition flex gap-7 px-[25px] z-[999] flex-col lg9:flex-row bg-dark-main lg9:bg-transparent fixed top-0 right-0 w-full sm2:w-[400px] pb-7 lg9:pb-0 pt-[92px] lg9:pt-0 sm2:border-l-2 border-content-main lg9:border-0 overflow-y-auto max-h-screen h-screen lg9:h-auto lg9:w-auto bg- lg9:relative lg9:top-auto lg9:right-auto`}>
             <Link href="/" className={`font-semibold transition hover:-translate-y-1 ${typeof window !== "undefined" ? window.location.pathname === "/" ? "text-white" : "" : ""}`}>HOME</Link>
             <Link href="/about-us" className={`font-semibold transition hover:-translate-y-1 ${typeof window !== "undefined" ? window.location.pathname === "/about-us" ? "text-white" : "" : ""}`}>ABOUT US</Link>
             <Link href="/experiences-&-services" className={`font-semibold transition hover:-translate-y-1 ${typeof window !== "undefined" ? window.location.pathname === "/experiences-&-services" ? "text-white" : "" : ""}`}>EXPERIENCES & SERVICES</Link>
             <Link href="/careers" className={`font-semibold transition hover:-translate-y-1 ${typeof window !== "undefined" ? window.location.pathname === "/careers" ? "text-white" : "" : ""}`}>CAREERS</Link>
             <Link href="/our-involvement" className={`font-semibold transition hover:-translate-y-1 ${typeof window !== "undefined" ? window.location.pathname === "/our-involvement" ? "text-white" : "" : ""}`}>OUR INVOLVEMENT</Link>
             <Link href="/contact-us" className={`font-semibold transition hover:-translate-y-1 ${typeof window !== "undefined" ? window.location.pathname === "/contact-us" ? "text-white" : "" : ""}`}>CONTACT</Link>
