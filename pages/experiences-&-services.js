  ...
  return (
    ...
    <div className="bg-dark-main text-content-main">
      ...
      <div className="mainCont mt-[80px]">
        <div className="card-gradient relative rounded-[24px] px-10 py-16">
           ...
           <div className='heading font-[Audiowide] text-[50px] sm3:text-[60px] leading-[76px] uppercase relative z-10'>Always looking<br/> forward</div>
           <div className='font-[600] text-[20px] max-w-[500px] leading-[35px] relative z-10 mt-6'>Constantly expanding our skills and knowledge in the face of technology’s exponential growth!</div>
           <img src="/images/tower3.png" className='absolute bottom-0 right-10 h-[400px]' alt="tower" />
        </div>      
      </div>
      ...
      <div className="mainCont py-16 mt-[80px] sm:mt-[140px]">
          ...
          <div className="mt-16">
            ...
            <div className="text-[30px] text-white font-[600] uppercase w-full border-b border-gray-main pb-4 mb-7">Civil Engineering</div>
            ...
            <div className="mt-24">
            <img src="/images/logo12.svg" className='mb-7 w-[35px]' alt="logo" />
            <div className="text-[30px] text-white font-[600] uppercase w-full border-b border-gray-main pb-4 mb-7">TELECOMMUNICATIONS</div>
            <div className="grid grid-cols-2 gap-5 xl:gap-20">
              <div className='flex gap-6 flex-col'>
                  <div className="flex items-start gap-5">
                    <div className="rounded-full bg-content-main min-w-[13px] min-h-[13px] translate-y-2"></div>
            ...
            <div className="mt-24">
            <img src="/images/logo12.svg" className='mb-7 w-[35px]' alt="logo" />
            <div className="text-[30px] text-white font-[600] uppercase w-full border-b border-gray-main pb-4 mb-7">Engineering + Tests</div>
            <div className="grid grid-cols-2 gap-5 xl:gap-20">
              <div className='flex gap-6 flex-col'>
                  <div className="flex items-start gap-5">
                    <div className="rounded-full bg-content-main min-w-[13px] min-h-[13px] translate-y-2"></div>
