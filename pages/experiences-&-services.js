  ...
  return (
    ...
    <div className="bg-dark-main text-content-main">
      ...
      <div className="mainCont mt-[80px]">
        <div className="card-gradient relative overflow-hidden rounded-[24px] px-6 md:px-10 py-10 md:py-16">
           ...
           <img src="/images/tower3.png" className='absolute bottom-0 right-10 h-[300px] sm:h-[400px] opacity-30 lg:opacity-100' alt="tower" />
        </div>      
      </div>
