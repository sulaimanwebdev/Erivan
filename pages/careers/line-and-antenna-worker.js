      ...
      <div className="bg-dark-main text-content-main">
        ...
        <div className="relative w-full">
          ...
          <div className="mainCont relative z-10 flex items-center justify-center flex-col text-center h-auto py-[80px] md:min-h-[500px]">
            <div className="heading font-[Audiowide] text-[40px] sm6:text-[50px] sm3:text-[60px] sm:text-[70px] leading-[120%] uppercase">
              {" "}
              {t("antenatitle1")}
              <br className="hidden md:flex" /> {t("antenatitle2")}
            </div>
          </div>
        </div>
        ...
        <div className="mainCont grid grid-cols-1 lg4:grid-cols-2 gap-6 mt-[100px] lg4:mt-[140px]">
          <div className="bg-form-main rounded-[24px] p-6">
            ...
            <div className="flex gap-4 flex-col mt-5">
              <div className="flex items-start gap-5">
                ...
                <div className="text-[17px] leading-[30px]">{t("antena1")}</div>
              </div>

              <div className="flex items-start gap-5">
                <div className="rounded-full bg-content-main min-w-[12px] min-h-[12px] translate-y-[9px]"></div>
                <div className="text-[17px] leading-[30px]">{t("antena2")}</div>
              </div>

              <div className="flex items-start gap-5">
                <div className="rounded-full bg-content-main min-w-[12px] min-h-[12px] translate-y-[9px]"></div>
                <div className="text-[17px] leading-[30px]">{t("antena3")}</div>
              </div>

              <div className="flex items-start gap-5">
                <div className="rounded-full bg-content-main min-w-[12px] min-h-[12px] translate-y-[9px]"></div>
                <div className="text-[17px] leading-[30px]">{t("antena4")}</div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-form-main rounded-[24px] p-6">
            ...
            <div className="flex gap-4 flex-col mt-5">
              <div className="flex items-start gap-5">
                <div className="rounded-full bg-content-main min-w-[12px] min-h-[12px] translate-y-[9px]"></div>
                <div className="text-[17px] leading-[30px]">{t("antena5")}</div>
              </div>

              <div className="flex items-start gap-5">
                <div className="rounded-full bg-content-main min-w-[12px] min-h-[12px] translate-y-[9px]"></div>
                <div className="text-[17px] leading-[30px]">{t("antena6")}</div>
              </div>

              <div className="flex items-start gap-5">
                <div className="rounded-full bg-content-main min-w-[12px] min-h-[12px] translate-y-[9px]"></div>
                <div className="text-[17px] leading-[30px]">{t("antena7")}</div>
              </div>

              <div className="flex items-start gap-5">
                <div className="rounded-full bg-content-main min-w-[12px] min-h-[12px] translate-y-[9px]"></div>
                <div className="text-[17px] leading-[30px]">{t("antena8")}</div>
              </div>

              <div className="flex items-start gap-5">
                <div className="rounded-full bg-content-main min-w-[12px] min-h-[12px] translate-y-[9px]"></div>
                <div className="text-[17px] leading-[30px]">{t("antena9")}</div>
              </div>
            </div>
          </div>
        </div>
