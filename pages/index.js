    ...
    <div className="bg-dark-main text-content-main">
           ...
           <div className="mt-10 max-w-[400px]">
            <Link href="/" className='flex items-center justify-between group gap-5'>
              <div className="flex items-center gap-5">
                  ...
                  <div className='text-white font-[600] text-[19px] sm4:text-[20px]'>Civil engineering</div>
              </div>
              <div className='hidden sm4:flex transition group-hover:translate-x-1'><svg width="17" height="16" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M14.3389 4.552L2.86287 16.028L0.977539 14.1427L12.4522 2.66667H2.33887V0H17.0055V14.6667H14.3389V4.552Z" fill="white"/></svg></div>
            </Link>
            
            <Link href="/" className='flex items-center justify-between mt-8 group gap-5'>
              <div className="flex items-center gap-5">
                  ...
                  <div className='text-white font-[600] text-[19px] sm4:text-[20px]'>Telecommunications</div>
              </div>
              <div className='hidden sm4:flex transition group-hover:translate-x-1'><svg width="17" height="16" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M14.3389 4.552L2.86287 16.028L0.977539 14.1427L12.4522 2.66667H2.33887V0H17.0055V14.6667H14.3389V4.552Z" fill="white"/></svg></div>
            </Link>
            ...
            <Link href="/" className='flex items-center justify-between mt-8 group gap-5'>
              <div className="flex items-center gap-5">
                  ...
                  <div className='text-white font-[600] text-[19px] sm4:text-[20px]'>Engineering and testing</div>
              </div>
              <div className='hidden sm4:flex transition group-hover:translate-x-1'><svg width="17" height="16" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M14.3389 4.552L2.86287 16.028L0.977539 14.1427L12.4522 2.66667H2.33887V0H17.0055V14.6667H14.3389V4.552Z" fill="white"/></svg></div>
            </Link>
            ...
            <Link href="/" className='flex items-center justify-between mt-8 group gap-5'>
              <div className="flex items-center gap-5">
                  ...
                  <div className='text-white font-[600] text-[19px] sm4:text-[20px]'>Project management</div>
              </div>
              <div className='hidden sm4:flex transition group-hover:translate-x-1'><svg width="17" height="16" viewBox="0 0 18 17" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M14.3389 4.552L2.86287 16.028L0.977539 14.1427L12.4522 2.66667H2.33887V0H17.0055V14.6667H14.3389V4.552Z" fill="white"/></svg></div>
            </Link>
      ...
      <div className="mainCont py-16">
           ...
           <div className="mt-12 max-w-[1100px] mx-auto">
              <div className="flex lg:items-center lg:justify-between flex-col lg:flex-row gap-6 lg:gap-16">
                ...
                <div className='max-w-[800px] leading-[24px] text-[17px] mx-3 lg:mx-0'>Founded in 1981 by <span className='text-white font-[900]'>Pierre Lajeunesse</span>, the company was first known under the sole name of "Erivan". At that time, the company was working in civil engineering and construction of large-scale concrete jobs.</div>
              </div>
              ...
              <div className="mt-[50px] lg:mt-12 flex lg:items-center lg:justify-between flex-col lg:flex-row gap-6 lg:gap-16">
                ...
                <div className='max-w-[800px] leading-[24px] text-[17px] mx-3 lg:mx-0'>Adapting to the ever changing industry and to offer a competitive advantage, <span className='font-[900]'>Erivan opened an office in Mississauga, ON</span> to ensure a greater visibility and infiltrating the Ontario market.</div>
              </div>
      ...
      <div className="mainCont py-16 mt-[80px] sm:mt-[140px]">
        ...
        <div className="mt-12 flex items-center justify-evenly lg2:justify-between flex-wrap gap-y-6 gap-x-[40px] min-w-[800px] md:min-w-auto">
           <img src="/images/logos/logo1.svg" className='grayscale w-[200px]'/>
           <img src="/images/logos/logo2.svg" className='grayscale w-[160px]'/>
           <img src="/images/logos/logo3.svg" className='grayscale w-[200px]'/>
           <img src="/images/logos/logo4.svg" className='grayscale w-[100px]'/>
           <img src="/images/logos/logo5.svg" className='grayscale w-[170px]'/>
           <img src="/images/logos/logo6.svg" className='grayscale w-[170px]'/>
           <img src="/images/logos/logo7.svg" className='grayscale w-[200px]'/>
           <img src="/images/logos/logo8.svg" className='grayscale w-[200px]'/>
           <img src="/images/logos/logo9.svg" className='grayscale w-[200px]'/>
           <img src="/images/logos/logo10.svg" className='grayscale w-[200px]'/>
           <img src="/images/logos/logo11.svg" className='grayscale w-[200px]'/>
        </div>
        </div>
      ...
      <div className="mainCont pb-0 mt-[80px] sm:mt-[140px]">
          <div className='heading font-[Audiowide] text-[45px] sm3:text-[60px] text-center mb-12'>CONTACT US</div>
