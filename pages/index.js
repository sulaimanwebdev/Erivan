      ...
      <div className="bg-dark-main text-content-main">
        ...
        <div className="mainCont relative h-[450px] sm3:h-[500px] md:h-[700px] flex items-center justify-start">
          <div className="z-10 lg:translate-x-20">
            <div className=" heading font-[Audiowide] text-[40px] sm3:text-[50px] sm:text-[60px] 2xl:text-[70px] leading-[120%]">
              {t("title")}
              <br className="hidden sm3:flex" />
              {t("titltwo")}
              <br />
              {t("titlethree")}
              {t("titlefour") === "" ? <span></span> : <br />}
              {t("titlefour")}
            </div>
            <div className="text-[19px] leading-[30px] mt-5">
              {parse(t("descone"))}
            </div>
            <Link
              href="/careers"
              className="w-fit transition hover:-translate-y-1 flex items-center font-[600] gap-3 text-white border border-content-main rounded-full px-8 py-3 mt-8"
            >
              {t("btn")}
              <svg
                width="16"
          ...
          <img
            ...
            className="absolute top-0 right-0 h-[500px] sm3:h-[600px] md:h-[900px] opacity-30 lg4:opacity-100"
            alt="tower"
          />
        </div>
        ...
        <div className="max-w-[1200px] mx-auto mt-[150px]">
          <div className="mainCont relative flex items-center justify-end lg4:justify-between gap-5">
            <img
              ...
              className="h-[700px] opacity-30 lg:opacity-100 absolute top-0 left-0 lg:relative lg:top-auto lg:left-auto"
              alt="tower"
            />
            <div className="max-w-[600px] z-10 leading-[36px] sm:-translate-y-[20px]">
              <div className="text-[18px]">{t("longDesc")}</div>
              <div className="mt-10 max-w-[400px]">
                <Link
                  href="/"
                  className="flex items-center justify-between group gap-5"
                >
                  <div className="flex items-center gap-5">
                    <div className="rounded-full w-[55px] h-[55px] flex items-center justify-center bg-white">
                      <svg
                        width="23"
                        height="23"
                        viewBox="0 0 20 20"
                  ...
                  <div className="hidden sm4:flex transition group-hover:translate-x-1">
                    ...
                    >
                      <path
                        d="M14.3389 4.552L2.86287 16.028L0.977539 14.1427L12.4522 2.66667H2.33887V0H17.0055V14.6667H14.3389V4.552Z"
                        fill="white"
                      />
                    </svg>
                  </div>
                ...
                <Link
                  href="/"
                  className="flex items-center justify-between mt-8 group gap-5"
                >
                  <div className="flex items-center gap-5">
                    <div className="rounded-full w-[55px] h-[55px] flex items-center justify-center bg-white">
                      <svg
        ...
        <div className="relative w-full mt-[160px] sm:mt-[350px] lg:mt-[140px]">
          <img
            ...
            className="w-full h-full object-cover object-center absolute top-0 left-0 opacity-60 lg4:opacity-100"
            alt="engineers"
          />
          ...
          <div className="mainCont relative z-10 flex items-end h-[500px] lg4:h-[800px]">
            <div className="flex items-start flex-col lg4:flex-row lg4:justify-between gap-6 sm3:gap-10 w-full -translate-y-[50px] lg4:-translate-y-[100px]">
              <div className="heading uppercase font-[Audiowide] text-[43px] sm3:text-[50px] lg:text-[60px] 2xl:text-[70px] leading-[120%]">
                {t("join")} <br className="hidden sm3:flex" />
                {t("jointwo")}
              </div>
              <div className="max-w-[500px]">
                <div className="text-[17px] leading-[24px] lg:mt-5">
                  {t("joindesone")}
                  <br />
                ...
                <Link
                  href="/careers"
                  className="w-fit transition hover:-translate-y-1 flex items-center font-[600] gap-3 text-white border border-content-main rounded-full px-6 py-3.5 mt-5"
                >
                  {t("joinbtn")}
                  <svg
                    width="16"
        ...
        <div className="bg-dark2-main w-full mt-[140px]">
          <div className="mainCont py-16">
            <div className="heading font-[Audiowide] text-[45px] sm3:text-[60px] text-center">
              {t("history")}
            </div>
            ...
            <div className="mt-12 max-w-[1100px] mx-auto">
              <div className="flex lg:items-center lg:justify-between flex-col lg:flex-row gap-6 lg:gap-16">
                <div className="rounded-full border border-white sm3:min-w-[350px] px-12 py-3.5">
                  <div className="font-[Audiowide] text-white flex items-center gap-3 text-[35px] mb-[2px]">
                    1981{" "}
                    <svg
                      width="15"
                      height="15"
                    ...
                    >
                      <path
                        d="M12.4534 14.3387L0.976074 2.86266L2.86141 0.977325L14.3374 12.452V2.33866H17.0041V17.0053H2.33741V14.3387H12.4534Z"
                        fill="white"
                      />
                    </svg>
                  </div>
                  <div>{t("historysideText1")}</div>
                </div>

                <div className="max-w-[800px] leading-[24px] text-[17px] mx-3 lg:mx-0">
                  {t("historyone")}
                </div>
              </div>
              ...
              <div className="mt-[50px] lg:mt-12 flex lg:items-center lg:justify-between flex-col lg:flex-row gap-6 lg:gap-16">
                <div className="rounded-full border border-white sm3:min-w-[350px] px-12 py-3.5">
                  ...
                  <div>{t("historysideText3")}</div>
                </div>

                <div className="max-w-[800px] leading-[24px] text-[17px] mx-3 lg:mx-0">
                  {parse(t("historythree"))}
                </div>
              </div>
              ...
              <div className="mt-[50px] lg:mt-12 flex lg:items-center lg:justify-start flex-col lg:flex-row gap-6 lg:gap-16">
                <div className="rounded-full bg-white border border-white sm3:min-w-[350px] px-12 py-3.5">
                  <div className="font-[Audiowide] text-black flex items-center gap-3 text-[35px] mb-[2px]">
                    2004{" "}
                    <svg
                      width="15"
                      height="15"
                  ...
                  <div>{parse(t("historysideText4"))}</div>
                </div>

                <div className="max-w-[800px] leading-[36px] text-[20px] mx-3 lg:mx-0">
                  {parse(t("historyfour"))}
                </div>
              </div>
        ...
        <div className="max-w-[900px] mx-auto">
          <div className="mainCont pb-0 mt-[80px] sm:mt-[140px]">
            <div className="heading font-[Audiowide] text-[45px] sm3:text-[60px] text-center mb-12">
              {t("homecontact")}
            </div>
